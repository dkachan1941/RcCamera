...
//        adapter.addFragment(new CameraContentFragment(), "Камера");
        adapter.addFragment(new ImageContentFragment(), "Фото");
        adapter.addFragment(new VideoContentFragment(), "Видео");
